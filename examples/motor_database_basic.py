...
def main():
  ...
  # Example 3: Automatic GitHub fallback (if motor not found locally)
  print("\n3. Loading motor with GitHub fallback:")
  print("   Trying to load: dynamixel_xl330_m288_t")
  print("   (Will fetch from GitHub if not found locally)")
  try:
    github_motor = load_motor_spec("dynamixel_xl330_m288_t")
    print(f"   ✓ Loaded: {github_motor.motor_id}")
    print(f"   ✓ Manufacturer: {github_motor.manufacturer}")
    print("   ✓ Source: GitHub (cached locally)")
  except FileNotFoundError as e:
    print(f"   ✗ Not found: {e}")

  # Example 4: Compare motors
  print("\n4. Comparing motors:")
